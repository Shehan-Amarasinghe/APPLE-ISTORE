...
public class ItemUI extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
      Items obj= new Items();
      obj.setItemCode(itemCode.getText().toString());
      obj.setItemName(itemName.getText().toString());
      obj.setItemPrice(Integer.valueOf(itemPrice.getText().toString()));
      obj.setItemType(itemType .getText().toString());
